...
namespace Magician.Common.Emit
{
    ...
    public static class EmitHelper
    {
        ...
        private static readonly MethodInfo MakeByRefTypeMethodInfo;

        #region static Ctor
        static EmitHelper()
        {
            EmitHelper.GetTypeFromHandleMethodInfo = typeof(Type).GetMethod("GetTypeFromHandle", new[] { typeof(RuntimeTypeHandle) });
